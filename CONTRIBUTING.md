...
<https://github.com/PrinceRichfather/spacopt/issues>.
...
Ready to contribute? Here\'s how to set up [spacopt]{.title-ref} for
local development.

1.  Fork the [spacopt]{.title-ref} repo on GitHub.
...
3.  The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and
    for PyPy. Check
    <https://travis-ci.com/PrinceRichfather/spacopt/pull_requests> and
...
``` {.shell}
$ python -m unittest tests.test_spacopt
```
